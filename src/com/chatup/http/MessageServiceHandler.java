...
class MessageServiceHandler extends HttpDispatcher
{
	...
	protected HttpResponse parsePostResponse(JsonValue jsonValue)
	{
		...
		final Message newMessage = new Message(jsonObject.getInt(HttpFields.RoomId, -1), jsonObject.getString(HttpFields.UserToken, null),
				jsonObject.getLong(HttpFields.Timestamp, -1L), jsonObject.getString(HttpFields.UserMessage, null));
